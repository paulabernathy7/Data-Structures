...
class LinkedList:
    ...
    def add_to_tail(self, value):
        # wrap the input value in a node. NEED TO DO THIS BEFORE ADDING VALUE TO LIST
    ...
    def remove_head(self):
        # check to see if there is no head. return None if there is no head (i.e. the list is empty)
        if not self.head:
            return None
